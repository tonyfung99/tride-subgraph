...
export function createCreateOrgProfileEvent(
  ...
  let orgParam = new ethereum.EventParam(
    "orgInfo",
    ethereum.Value.fromTuple(orgInfo)
  );
...
export function createEventCreatedEvent(
  ...
  const orgIdParam = new ethereum.EventParam(
    "OrgId",
    ethereum.Value.fromI32(orgId)
  );
  const codeParam = new ethereum.EventParam(
    "code",
  ...
  const startDateParam = new ethereum.EventParam(
    "start_date",
    ethereum.Value.fromI32(start_date)
  );
  const endDateParam = new ethereum.EventParam(
    "end_date",
    ethereum.Value.fromI32(end_date)
  );
